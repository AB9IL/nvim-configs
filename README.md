...
- Select the minimal or regular setup depending on your text editing needs.
  - Use Neovim 0.12.0 or later for the full featured config
  - Use Neovim 0.5.0 or later for the minimal config
- Lazy.nvim manages the plugins. Execute **:Lazy** and select **Install** to install them the first time.
- Select **Update** in Lazy for future updates.
- If you make changes to accommodate significant updates, execute **Sync**
