...
require("lazy").setup({
	...
	{ "echasnovski/mini.nvim", version = false }, -- Collection of useful modularized plugins
	{
		"folke/snacks.nvim",
		priority = 1000,
		lazy = false,
	...
	}, -- Collection of useful modularized plugins
	"neovim/nvim-lspconfig", -- Collection of configurations for built-in LSP client
    {
        "stevearc/conform.nvim",
	    opts = {},
	    event = { "BufReadPre", "BufNewFile" }, -- formatter
    },
	{
